...
//Copied this code from https://github.com/googlesamples/android-play-places/blob/master/PlaceCompleteAdapter/Application/src/main/java/com/example/google/playservices/placecomplete/PlaceAutocompleteAdapter.java
...
public class PlaceAutocompleteAdapter
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String s = item.getPrimaryText(STYLE_BOLD).toString() + ", " + item.getSecondaryText(STYLE_BOLD).toString();
        textView1.setText(s);
